...
//    GosLog(@"_oneMinData:%lu  data:%lu",(unsigned long)_oneMinData.length,(unsigned long)data.length);
}

- (void)connectionDidFinishLoading:(NSURLConnection *)connection{
    GosLog(@"connectionDidFinishLoading");
    [self finishMeasure];
}


- (void)dealloc {
    GosLog(@"MeasurNetTools dealloc");
}
