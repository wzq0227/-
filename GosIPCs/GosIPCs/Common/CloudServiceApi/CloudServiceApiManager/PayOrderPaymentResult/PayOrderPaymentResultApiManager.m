//  PayOrderPaymentResultApiManager.m
//  CloudStoreSDK
//
//  Create by daniel.hu on 2018/12/11.
//  Copyright © 2018年 daniel. All rights reserved.

#import "PayOrderPaymentResultApiManager.h"
#import "YYModel.h"
...
@interface PayOrderPaymentResultApiManager () <GosApiManagerValidator, GosApiManagerParamSource>
/// 签名
...
@implementation PayOrderPaymentResultApiManager
...
+ (NSInteger)loadDataWithPayOrder:(PayOrderApiRespModel *)payOrder success:(void (^)(GosApiBaseManager * _Nonnull))successCallback fail:(void (^)(GosApiBaseManager * _Nonnull))failCallback {
    PayOrderPaymentResultApiManager *api = [[PayOrderPaymentResultApiManager alloc] init];
...
- (NSString *)methodName {
    return @"inland/cloudstore/payment/query";
}
...
- (id)manager:(GosApiBaseManager *)manager reformData:(NSDictionary *)data {
    return [PayOrderPaymentResultApiRespModel yy_modelWithDictionary:[data objectForKey:kCloudServiceApiRespKeyData]];
}
