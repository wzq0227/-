//  WechatPaymentApiManager.m
//  CloudStoreSDK
//
//  Create by daniel.hu on 2018/12/11.
//  Copyright © 2018年 daniel. All rights reserved.

#import "WechatPaymentApiManager.h"
#import "YYModel.h"
#import "WechatPaymentApiRespModel.h"
...
@interface WechatPaymentApiManager () <GosApiManagerValidator, GosApiManagerParamSource>
/// 签名
...
@implementation WechatPaymentApiManager
...
+ (NSInteger)loadDataWithOrderNumber:(NSString *)orderNumnber success:(void (^)(GosApiBaseManager * _Nonnull))successCallback fail:(void (^)(GosApiBaseManager * _Nonnull))failCallback {
    WechatPaymentApiManager *api = [[WechatPaymentApiManager alloc] init];
...
- (NSString *)methodName {
    return @"wechat/order/prepare/goscam";
}
...
- (id)manager:(GosApiBaseManager *)manager reformData:(NSDictionary *)data {
    return [WechatPaymentApiRespModel yy_modelWithDictionary:[data objectForKey:kCloudServiceApiRespKeyData]];
}
