...
#import "UIDevice+GosDevCheck.h"
#import <sys/utsname.h>

@implementation UIDevice (GosDevCheck)
...
- (DeviceType)deviceType
{
    ...
    if (!deviceNamesByCode) {
        ...
        deviceNamesByCode = @{
                              ...
                              @"iPod6,1"   : [NSNumber numberWithInteger:Device_iPod6],
                              ...
                              @"iphone10,1" : [NSNumber numberWithInteger:Device_iPhone8],
                              @"iphone10,2" : [NSNumber numberWithInteger:Device_iPhone8plus],
                              
                              @"iphone10,3" : [NSNumber numberWithInteger:Device_iPhoneX],
                              @"iphone11,2" : [NSNumber numberWithInteger:Device_iPhoneXS],
                              @"iphone11,4" : [NSNumber numberWithInteger:Device_iPhoneXSMax],
                              @"iphone11,6" : [NSNumber numberWithInteger:Device_iPhoneXSMax],
                              @"iphone11,8" : [NSNumber numberWithInteger:Device_iPhoneXR],
                              };
    }
...
- (ScreenType)screenType
{
    ...
    else if (Device_iPhoneX == currentDeviceType
             || Device_iPhoneXS == currentDeviceType)
    {
        iPhoneScreenSize = Screen_iPhone_5_8_inch;
    }
    else if (Device_iPhoneXR == currentDeviceType)
    {
        iPhoneScreenSize = Screen_iPhone_6_1_inch;
    }
    else if (Device_iPhoneXSMax == currentDeviceType)
    {
        iPhoneScreenSize = Screen_iPhone_6_5_inch;
    }
